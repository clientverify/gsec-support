...
config_klee()
{
  ...
  KLEE_CONFIG_OPTIONS+="LDFLAGS=\"-L$BOOST_ROOT/lib -L$GOOGLE_PERFTOOLS_ROOT/lib -L${GNU_SHARED_LIBS} -Wl,-rpath=${GNU_SHARED_LIBS}\" "
  KLEE_CONFIG_OPTIONS+="CPPFLAGS=\"-I$BOOST_ROOT/include -I$GOOGLE_PERFTOOLS_ROOT/include\" "
  KLEE_CONFIG_OPTIONS+="CXXFLAGS=\"-I$BOOST_ROOT/include -I$GOOGLE_PERFTOOLS_ROOT/include\ -I${GNU_INCLUDE}\" "
  KLEE_CONFIG_OPTIONS+="CFLAGS=\"-I${GNU_INCLUDE}\" "
