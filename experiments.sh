...
# leave their own log files, named ${PROGNAME}_${DATETIME}.log. These
# log files contain the executed command line and and also capture
...
# subdirectory.
#
# [klee-droppings] ${ROOT_DIR}/data/${EXPERIMENT}/${CLIENT}/${DATE=NETDATA}
# -------------------------------------------------------------------------
#
...
#
# [results] ${ROOT_DIR}/data/results/${CLIENT}/(data|plots)/${NETDATA}/...
# ------------------------------------------------------------------------
#
# The results directories are generated by this script and subordinate
# R scripts.  Conceptually, there are actually 3 copies of the
# statistics data:
